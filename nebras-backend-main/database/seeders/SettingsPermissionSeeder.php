...
class SettingsPermissionSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if ($superAdmin) {
            $settingsPermissions = Permission::where('name', 'like', "%{$module}%")->get();
            $superAdmin->givePermissionTo($settingsPermissions);
            $this->command->info('Assigned Settings permissions to Super Admin role');
        }
