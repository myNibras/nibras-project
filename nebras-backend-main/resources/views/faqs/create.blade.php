            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
                        <h6 class="text-white text-capitalize px-3">{{ __('app.faqs') }} - {{ __('app.add new') }}</h6>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="question_en" id="question_en" maxlength="100"
                                        class="form-control" value="{{ old('question_en') }}"
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="answer" id="answer" rows="6" class="form-control"
                                        placeholder="{{ __('app.answer') }} (AR) - {{ __('app.line breaks supported') }}" required>{{ old('answer') }}</textarea>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="answer_en" id="answer_en" rows="6" class="form-control"
                                        placeholder="{{ __('app.answer') }} (EN) - {{ __('app.line breaks supported') }}" required>{{ old('answer_en') }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="alert alert-info mb-0 py-2 px-3 d-flex align-items-center gap-2" style="font-size: .9rem;">
                                        ...
                                        <span>{{ __('app.order is managed via drag-and-drop in the faqs list') }}</span>
                                    </div>
                                </div>
                            </div>
