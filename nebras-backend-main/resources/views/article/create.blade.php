@extends('layouts.app')
@section('title'){{ __('app.article') }} - {{ __('app.add new') }}@endsection
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
                        <h6 class="text-white text-capitalize px-3">{{ __('app.article') }} - {{ __('app.add new') }}</h6>
                ...
                <div class="card-body px-0 pb-2">
                    ...
                    <form action="{{ route('article.store') }}" method="POST" enctype="multipart/form-data" id="article-form">
                        @csrf
                        <div class="row mx-3 row-gap-3 w-100">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="small_description_ar" id="small_description_ar" class="form-control" rows="3" maxlength="100" required>{{ old('small_description_ar') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="small_description_en" id="small_description_en" class="form-control" rows="3" maxlength="100" required>{{ old('small_description_en') }}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="creation_date" id="creation_date" class="form-control" 
                                        placeholder="{{ __('app.creation date') }}" value="{{ old('creation_date') }}">
                                    @error('creation_date')
                                        <span class="text-danger small">{{ $message }}</span>
                                    @enderror
                                </div>
