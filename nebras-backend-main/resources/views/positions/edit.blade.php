@extends('layouts.app')
@section('title'){{ __('app.positions') }} - {{ __('app.edit') }}@endsection
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
                        <h6 class="text-white text-capitalize mb-0">{{ __('app.positions') }} - {{ __('app.edit') }} #{{ $position->id }}</h6>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name" id="name" placeholder="{{ __('app.name') }} (AR)"
                                        class="form-control" value="{{ old('name', $position->name) }}" maxlength="50">
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="name_en" id="name_en" placeholder="{{ __('app.name') }} (EN)"
                                        class="form-control" value="{{ old('name_en', $position->name_en) }}" maxlength="50">
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-12">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input" type="checkbox" name="status" id="status" value="1" {{ old('status', $position->status) ? 'checked' : '' }}>
