            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
                        <h6 class="text-white text-capitalize px-3">{{ __('app.teachers') }} - {{ __('app.add new') }}</h6>
                        ...
                        <div class="row mx-3 row-gap-3 w-100">
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email" id="email" placeholder="{{ __('app.email') }}"
                                           class="form-control" value="{{ old('email') }}" maxlength="255">
                                </div>

                                {{-- Password --}}
                                <div class="col-md-6">
                                    <label for="password" class="form-label fw-bold">{{ __('app.password') }}</label>
                                    <input type="password" name="password" id="password" placeholder="{{ __('app.password') }}"
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="years_of_experience" id="years_of_experience" min="0" step="1"
                                        class="form-control" value="{{ old('years_of_experience', 0) }}" placeholder="0">
                                </div>
                            </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="description" id="description" class="form-control" rows="4" maxlength="5000" placeholder="{{ __('app.description') }} (AR)">{{ old('description') }}</textarea>
                                </div>
                                {{-- Description (English) --}}
                                <div class="col-md-6">
                                    <label for="description_en" class="form-label fw-bold">{{ __('app.description') }} (EN)</label>
                                    <textarea name="description_en" id="description_en" class="form-control" rows="4" maxlength="5000" placeholder="{{ __('app.description') }} (EN)">{{ old('description_en') }}</textarea>
                                </div>
                            </div>
