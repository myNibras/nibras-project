                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0" style="position:relative; z-index:1;">
                  ...
                  <tr>
                    <td align="center" style="padding:0 20px;">
                      ...
                      <p style="margin:15px auto 25px; font-weight:400; font-size:16px; line-height:130%; color:#545F71; max-width:75%; text-align:center;">We’re excited to welcome you to Nibbraas Learning Platform 🚀</b></p>
                      <p style="margin:15px auto 25px; font-weight:400; font-size:16px; line-height:130%; color:#545F71; max-width:75%; text-align:center;">Your account has been successfully created, and you’re now ready to start your learning journey with us.</p>
                      <p style="margin:15px auto 25px; font-weight:400; font-size:16px; line-height:130%; color:#545F71; max-width:75%; text-align:center;">👉 Click here to log in and get started: <a href="https://mynibras.com">Website link</a></p>
