...
<head>
    <meta charset="UTF-8">
    <title>🎉 أهلاً بك في منصة نبراس التعليمية!</title>
    <!-- Tajawal Font -->
                  ...
                  <tr>
                    <td align="center" style="padding:0 20px;">
                      ...
                      <p style="margin:15px auto 25px; font-weight:400; font-size:16px; line-height:150%; color:#545F71; max-width:80%; text-align:center;">
                         يسعدنا انضمامك إلى منصة نبراس التعليمية 🚀
                      </p>
                      <p style="margin:15px auto 25px; font-weight:400; font-size:16px; line-height:150%; color:#545F71; max-width:80%; text-align:center;">
                        تم إنشاء حسابك بنجاح، وأنت الآن جاهز لبدء رحلتك التعليمية معنا.
                      </p>
                      <p style="margin:15px auto 25px; font-weight:400; font-size:16px; line-height:150%; color:#545F71; max-width:80%; text-align:center;">
                        👉 اضغط هنا لتسجيل الدخول والبدء: <a href="https://mynibras.com">رابط الموقع</a>
                      </p>
                      <p style="margin:15px auto 25px; font-weight:400; font-size:16px; line-height:150%; color:#545F71; max-width:80%; text-align:center;">
                        مع تحياتنا،
                        <br>
