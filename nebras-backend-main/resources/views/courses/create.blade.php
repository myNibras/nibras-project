@extends('layouts.app')
@section('title'){{ __('app.courses') }} - {{ __('app.add new') }}@endsection
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
                        <h6 class="text-white text-capitalize px-3">{{ __('app.courses') }} - {{ __('app.add new') }}</h6>
                    ...
                    <form action="{{ route('courses.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="tab-content mt-3 mx-3" id="courseTabsContent">
                            ...
                            <div class="tab-pane fade show active" id="step1" role="tabpanel">
                                <div class="row row-gap-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <textarea name="short_description_en" class="form-control" rows="2" required>{{ old('short_description_en') }}</textarea>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="number" step="1" min="0" name="available_seats" class="form-control" value="{{ old('available_seats') }}" placeholder="{{ __('app.optional') }}">
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select name="payment_type" id="payment_type" class="form-control form-select px-2" required>
                                            <option value="one-off" {{ old('payment_type', 'one-off') == 'one-off' ? 'selected' : '' }}>One-Off</option>
                                            <option value="monthly" {{ old('payment_type') == 'monthly' ? 'selected' : '' }}>Monthly (Installments)</option>
                                            <option value="both" {{ old('payment_type') == 'both' ? 'selected' : '' }}>Both</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6" id="semester_months_wrapper" style="display: none;">
                                        <label class="form-label fw-bold">{{ __('app.semester_months') }}</label>
                                        <input type="number" step="1" min="1" name="semester_months" id="semester_months" class="form-control" value="{{ old('semester_months') }}">
                                    </div>
                                    <div class="col-md-6" id="monthly_amount_wrapper" style="display: none;">
                                        <label class="form-label fw-bold">{{ __('app.monthly_amount') }}</label>
                                        <input type="number" step="0.01" min="0" name="monthly_amount" id="monthly_amount" class="form-control" value="{{ old('monthly_amount') }}" disabled readonly>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name="course_type" id="course_type" class="form-control form-select px-2" required>
                                            <option value="recorded" {{ old('course_type', 'recorded') == 'recorded' ? 'selected' : '' }}>{{ __('app.recorded') }}</option>
                                            <option value="online" {{ old('course_type') == 'online' ? 'selected' : '' }}>{{ __('app.online') }}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6" id="course_link_wrapper" style="display: {{ old('course_type') == 'online' ? 'block' : 'none' }};">
                                        <label class="form-label fw-bold">{{ __('app.course link') }}</label>
                                        <input type="text" name="course_link" id="course_link" class="form-control" value="{{ old('course_link') }}" maxlength="255" placeholder="https://...">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="image">{{ __('app.image') }} - {{ __('app.size')}} (393x393px)</label>
                                        <input type="file" id="image" name="image" data-plugins="dropify" data-height="150" data-allowed-file-extensions="png jpg jpeg webp" required />
                            ...
                            <div class="tab-pane fade" id="step2" role="tabpanel">
                                <div class="row row-gap-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="duration_en" class="form-control" value="{{ old('duration_en') }}" required>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="schedule_en" class="form-control" value="{{ old('schedule_en') }}" required>
                                    </div>
                                  <div class="col-md-6">
                            ...
                            <div class="tab-pane fade" id="step4" role="tabpanel">
                                ...
                                <div id="curriculums-wrapper"></div>
                                <button type="button" class="btn btn-success mt-2" onclick="addCurriculum()">+ {{ __('app.add new unit') }}</button>
                            </div>
                        </div>
...
function buildCurriculumCardHtml() {
    ...
    <div class="card p-3 mt-3 position-relative curriculum-card">
        ...
        <h6 class="fw-bold mt-3">{{ __('app.unit') }} <span class="curriculum-card-number">1</span></h6>
        <div class="row">
        ...
        <div class="curriculum-units" id="units-temp"></div>
