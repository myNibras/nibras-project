            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
                        <h6 class="text-white text-capitalize px-3">{{ __('app.students') }} - {{ __('app.edit')." #".$student->id }}</h6>
                        ...
                        <div class="row mx-3 row-gap-3 w-100">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="name" id="name" placeholder="{{ __('app.full name') }}" 
                                        class="form-control" value="{{ old('name', $student->name) }}">
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="number" name="age" min="1" id="age" placeholder="{{ __('app.age') }}" 
                                        class="form-control" value="{{ old('age', $student->age) }}">
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <select name="gender" id="gender" class="form-select ps-2">
                                        ...
                                        <option value="0" {{ old('gender', $student->gender) == 0 ? 'selected' : '' }}>{{ __('app.male') }}</option>
                                        <option value="1" {{ old('gender', $student->gender) == 1 ? 'selected' : '' }}>{{ __('app.female') }}</option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="file" id="profile_picture" name="profile_picture" data-default-file="{{ $student->profile_picture }}" data-plugins="dropify" data-height="150" data-allowed-file-extensions="png jpg jpeg webp" />
...
<script>
    $(document).ready(function() {
        ...
        var drEvent = $('#profile_picture').dropify();
