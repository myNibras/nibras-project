@extends('layouts.app')
@section('title'){{ __('app.news') }} - {{ __('app.add new') }}@endsection
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
                        <h6 class="text-white text-capitalize px-3">{{ __('app.news') }} - {{ __('app.add new') }}</h6>
                        ...
                        <div class="row mx-3 row-gap-3 w-100">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="title_ar" id="title_ar" placeholder="{{ __('app.title') }} (AR)"
                                        class="form-control" value="{{ old('title_ar') }}" maxlength="50" required>
                                    @error('title_ar')
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="title_en" id="title_en" placeholder="{{ __('app.title') }} (EN)"
                                        class="form-control" value="{{ old('title_en') }}" maxlength="50" required>
                                    @error('title_en')
                                        <span class="text-danger small">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="small_description_ar" id="small_description_ar" class="form-control" rows="3" maxlength="150" required>{{ old('small_description_ar') }}</textarea>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="small_description_en" id="small_description_en" class="form-control" rows="3" maxlength="150" required>{{ old('small_description_en') }}</textarea>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="expiry_date" id="expiry_date" class="form-control" 
                                        placeholder="{{ __('app.expiry date') }}" value="{{ old('expiry_date') }}">
                                    @error('expiry_date')
                                        <span class="text-danger small">{{ $message }}</span>
                                    @enderror
                                </div>
