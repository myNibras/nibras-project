@extends('layouts.app')
@section('title'){{ __('app.candidates') }}@endsection
            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3 d-flex justify-content-between align-items-center px-3">
                        <h6 class="text-white text-capitalize mb-0">{{ __('app.candidates') }}</h6>
                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive px-3">
                        <table id="candidates-table" class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    <th class="text-secondary font-weight-bolder opacity-7 text-center" style="width:70px">{{ __('app.id') }}</th>
                                    ...
                                    <th class="text-secondary font-weight-bolder opacity-7">{{ __('app.major specialization') }}</th>
...
<script>
    ...
    function handleTable(){
        ...
        $('#candidates-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                "url": "{{ LaravelLocalization::localizeUrl(route('candidates.index')) }}",
                "data": {},
                "type": "GET"
            },
            order: [[0, 'desc']],
